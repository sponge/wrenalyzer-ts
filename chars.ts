...
class Chars {
  ...
  static isDigit(c) { return c >= Chars.zero && c <= Chars.nine }

  static isAlphaNumeric(c) { return Chars.isAlpha(c) || Chars.isDigit(c) }
  ...
  static isLowerAlpha(c) { return c >= Chars.lowerA && c <= Chars.lowerZ }
}
